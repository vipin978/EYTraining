...
public class Consignment1 {
	...
	public static PackageTracker pTracker;
	public static LocalDateTime getReachTime(LocalDateTime datetime) {
		return new PackageTracker(datetime, 200, 5).calculateReachTime();
	}
...
class PackageTrackerUtil{
	...
	public static LocalDateTime getEndDateTime(LocalDateTime start) {
		...
		if(start.getHour() < 6) {
			...
			System.out.println("END DAY OF  "+end);
		}
		return end;
	}
